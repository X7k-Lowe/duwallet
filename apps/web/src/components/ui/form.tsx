...
interface FormItemProps extends Omit<React.HTMLAttributes<HTMLDivElement, any>, 'className' | 'children'> {
  className?: string;
...
interface FormDescriptionProps extends Omit<React.HTMLAttributes<HTMLParagraphElement, any>, 'className' | 'children'> {
  className?: string;
  children?: React.ReactNode;
}
...
interface FormMessageProps extends Omit<React.HTMLAttributes<HTMLParagraphElement, any>, 'className' | 'children'> {
  className?: string;
  children?: React.ReactNode;
}
