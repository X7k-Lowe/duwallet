...
| 技術                                                      | バージョン | 用途・選定理由                                                                                                 |
| --------------------------------------------------------- | ---------- | -------------------------------------------------------------------------------------------------------------- |
| [Supabase](https://supabase.com/)                            | 2.49.4     | オープンソースのFirebase代替。認証、データベース(`@supabase/supabase-js`として利用)、ストレージを統合したバックエンドサービス。無料枠が十分に広い |
...
| 技術                                                                        | バージョン | 用途・選定理由                                              |
| --------------------------------------------------------------------------- | ---------- | ----------------------------------------------------------- |
| [Supabase Auth](https://supabase.com/docs/guides/auth)                         | -          | メールアドレス認証やソーシャルログインの実装。MFA対応も可能 |
...
| [Docker / Docker Compose](https://www.docker.com/) | 24.x       | ローカル開発で Supabase(PostgreSQL) & アプリをワンコマンド起動。CI/CD の一貫性確保 |
